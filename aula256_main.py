...
import aula256_banco

c1 = aula256_clientes.Cliente('Luiz', 30)
cc1 = aula256_contas.ContaCorrente(111, 222, 0, 0)
c1.conta = cc1
c2 = aula256_clientes.Cliente('Maria', 18)
cp1 = aula256_contas.ContaPoupança(112, 223, 100)
c2.conta = cp1
banco = aula256_banco.Banco()
